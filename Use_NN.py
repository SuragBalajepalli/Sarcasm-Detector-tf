"""
 Input statement to the neural net must be typed between parantheses of use_neural_network().
...
def use_neural_network(input_data):
    """
    Restoring the previously trained weights and biases.
    """
...
if __name__ == '__main__':
    use_neural_network("I am having way too much fun at this party")
